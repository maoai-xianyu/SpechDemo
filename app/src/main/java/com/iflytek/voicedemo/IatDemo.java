...
//                mIat.setParameter(SpeechConstant.AUDIO_SOURCE, "-1");
                ...
                mIat.setParameter(SpeechConstant.ASR_SOURCE_PATH, Environment.getExternalStorageDirectory()+"/xx/RawAudio.pcm");
                File file = new File(Environment.getExternalStorageDirectory()+"/xx/RawAudio.pcm");
                Log.e("-----",file.exists()+"");
                ret = mIat.startListening(mRecognizerListener);
                showTip("码：" + ret);
                /*if (ret != ErrorCode.SUCCESS) {
